...
--------------------------------------------------`);
    ...
    try {
        ...
        const endYear = moment(userContractInfo.emp_start_date.getTime()).add(newCareerYear, "y").subtract(1, "d").format("YYYY-MM-DD");
        // console.log(endYear);
        ...
        if (used_annual_leave + req.body.leaveDuration > MyTotalLeave.annual_leave) {
            if (MyTotalLeave.annual_leave - used_annual_leave <= 0) {
                ...
                NextYearTotalLeave.annual_leave =
                    NextYearTotalLeave.annual_leave - (used_annual_leave + req.body.leaveDuration) + MyTotalLeave.annual_leave;
            }
        }
