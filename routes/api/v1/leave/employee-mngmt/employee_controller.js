...
--------------------------------------------------`);
  ...
  try {
    ...
    const updatedData = await dbModels.Manager.findOneAndUpdate(
      updateCriteria,
      updateData
    );
    if (!updatedData) {
    ...
    const updatedUser = await dbModels.Member.findOneAndUpdate(
      criteria,
      updateManagerData
    );
    if (!updatedUser) {
...
--------------------------------------------------`);
  ...
  try {
    ...
    const employee = await dbModels.Member.findOneAndUpdate(
      criteria,
      updateData
    );
